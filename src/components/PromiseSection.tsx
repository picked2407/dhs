  ...
  return <motion.section id="price" ref={ref} initial="hidden" animate={isInView ? "visible" : "hidden"} variants={containerVariants} className="relative h-screen min-h-[800px] flex items-center justify-center overflow-hidden scroll-mt-16">
      ...
      <motion.div variants={containerVariants} className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        scale: 0.95
          ...
          <Button className="bg-white text-black hover:text-primary font-display font-bold text-sm sm:text-base px-8 sm:px-12 lg:px-16 py-4 sm:py-6 h-auto uppercase tracking-wider shadow-2xl transition-all duration-300 border-2 border-white w-full sm:w-auto max-w-xs sm:max-w-none mx-auto">
            APPLY NOW
          </Button>
        </motion.div>
      </motion.div>
